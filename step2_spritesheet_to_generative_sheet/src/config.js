...
let layerConfigurations = [
  ...
  },
  {
    ...
    layersOrder: [
      ...
      { name: "FemaleBack", trait: "Back"  },
      { name: "FemaleCommonBody", trait: "Body"  },
      { name: "FemaleCommonHead", trait: "Head"  },
      { name: "EyesCommon", trait: "Eyes"  },
      { name: "FemaleUncommonHairBackground" },
      { name: "FemaleUncommonArmor", trait: "Armor"  },
      { name: "FemaleCommonHairForeground", trait: "Hair"  },
      { name: "Headgear" },
      { name: "QioraForeground", trait: "Qiora" },
    ],
  },
  {
    ...
    layersOrder: [
      ...
      { name: "QioraBackground" },
      { name: "FemaleBack", trait: "Back"   },
      { name: "FemaleRareBody", trait: "Body"  },
      { name: "FemaleRareHead", trait: "Head"  },
      { name: "EyesRare", trait: "Eyes"  },
      { name: "FemaleRareHairBackground" },
      { name: "FemaleRareArmor", trait: "Armor"  },
      { name: "FemaleRareHairForeground", trait: "Hair"  },
      { name: "Headgear" },
      { name: "QioraForeground", trait: "Qiora" },
    ],
  },
  {
    ...
    layersOrder: [
      { name: "Background" },
      { name: "QioraBackground" },
      { name: "MaleCommonBody", trait: "Body"  },
      { name: "MaleCommonHead", trait: "Head"  },
      { name: "EyesCommon", trait: "Eyes"  },
      { name: "MaleCommonHair", trait: "Hair"  },
      { name: "MaleCommonArmor", trait: "Armor"  },
      { name: "Headgear" },
      { name: "QioraForeground", trait: "Qiora" },
    ],
  },
  {
    ...
    layersOrder: [
      { name: "Background" },
      { name: "QioraBackground" },
      { name: "MaleBack", trait: "Back"   },
      { name: "MaleCommonBody", trait: "Body"  },
      { name: "MaleCommonHead", trait: "Head"  },
      { name: "EyesCommon", trait: "Eyes"  },
      { name: "MaleCommonHair", trait: "Hair"  },
      { name: "MaleUncommonArmor", trait: "Armor"  },
      { name: "Headgear" },
      { name: "QioraForeground", trait: "Qiora" },
    ],
  },
  {
    ...
    layersOrder: [
      ...
      { name: "QioraBackground" },
      { name: "MaleBack", trait: "Back"   },
      { name: "MaleRareBody", trait: "Body"  },
      { name: "MaleRareHead", trait: "Head"  },
      { name: "EyesRare", trait: "Eyes"  },
      { name: "MaleRareHair", trait: "Hair"  },
      { name: "MaleRareArmor", trait: "Armor"  },
      { name: "Headgear" },
      { name: "QioraForeground", trait: "Qiora" },
    ],
  },
